            ...
            <nav className="navbar navbar-expand-lg bg-body-tertiary">
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
                        <Link to="/" className="navbar-brand" > <GiShop /> E-Commerce App </Link>
                        ...
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
...

                                    {
                                        categories?.map((singleCategory, i) => {
                                            ...
                                            return (
                                                ...
                                                <li key={i}>
                                                    <Link className="dropdown-item" to={`/category/${singleCategory.slug}`}>{singleCategory.categoryName} </Link>
...

                            {
                                !auth.user ? (
                                    ...
                                    {/* <li> <NavLink onClick={handleLogout} to="/login" className="nav-link" > Log Out </NavLink> </li> */}
